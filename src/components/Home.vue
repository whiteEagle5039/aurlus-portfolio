...
<div class="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between relative z-10 px-4 sm:px-6 py-8 sm:py-12 gap-8 sm:gap-12">
  ...
  <div class="w-full lg:w-1/2 text-center lg:text-left backdrop-blur-sm bg-white bg-opacity-50 dark:bg-black dark:bg-opacity-10 p-4 sm:p-8 rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-gray-700 shadow-xl transition-colors duration-500">
    ...
    <div class="flex flex-wrap gap-2 mt-4 sm:mt-6 justify-center lg:justify-start">
      <span class="px-3 py-1 bg-gray-200 dark:bg-gray-800 bg-opacity-60 text-gray-700 dark:text-gray-300 text-xs sm:text-sm rounded-full border border-gray-300 dark:border-gray-700 transition-colors duration-500">Cybersécurité</span>
      <span class="px-3 py-1 bg-gray-200 dark:bg-gray-800 bg-opacity-60 text-gray-700 dark:text-gray-300 text-xs sm:text-sm rounded-full border border-gray-300 dark:border-gray-700 transition-colors duration-500">RSSI</span>
      <span class="px-3 py-1 bg-gray-200 dark:bg-gray-800 bg-opacity-60 text-gray-700 dark:text-gray-300 text-xs sm:text-sm rounded-full border border-gray-300 dark:border-gray-700 transition-colors duration-500">ISO 27001</span>
      <span class="px-3 py-1 bg-gray-200 dark:bg-gray-800 bg-opacity-60 text-gray-700 dark:text-gray-300 text-xs sm:text-sm rounded-full border border-gray-300 dark:border-gray-700 transition-colors duration-500">Gestion de Projets</span>
    </div>
      ...
      <div class="w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[450px] lg:h-[450px] xl:w-[550px] xl:h-[550px] relative">
        ...
        <div class="absolute inset-2 sm:inset-3 md:inset-4 rounded-full overflow-hidden border-4 sm:border-6 md:border-8 border-white dark:border-gray-900/70 shadow-2xl transition-colors duration-500">
          <img
            ...
            alt="Sogbossi aurlus - Expert en Cybersécurité"
